...
if (isset($_GET['search']) && $_GET['search'] !== "") {
    ...
    if ($search_type === "author") {
        $search_condition = "AND r.author_name LIKE '%$search%'";
    } else {
        $search_condition = "AND r.book_name LIKE '%$search%'";
    }
} else {
    $search_type = (isset($_GET['search_type']) && $_GET['search_type'] === "author")
                   ? "author"
...
$sql = "SELECT r.id, r.status, r.book_name, r.author_name
        FROM request r
...
<div class="sidebar">
    ...
    <div class="search-box">
        <form method="GET" action="requestcheck.php">
    ...
    <a href="requestcheck.php" class="active">Check Request</a>
...
<div class="main">
    ...
    <?php else: ?>
        <div class="no-requests">
            You have not made any book requests<?= $search ? " matching \"" . htmlspecialchars($search) . "\"" : "" ?> yet.
        </div>
    <?php endif; ?>
